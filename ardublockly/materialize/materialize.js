        ...
        a.fn.scrollTo = function(b) {
            ...
            this.each(function() {
                ...
                function e(b) {
                    ...
                    var o = 0,
                        p = g.parent();
                    if (!p.is("body") && p[0].scrollHeight > p[0].clientHeight && (o = p[0].scrollTop), k + j.innerWidth() > a(window).width() ? m = "right" : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"), l + j.innerHeight() > e)
                    ...
                    if ("left" === m) c = h.gutter, leftPosition = g.position().left + c;
                        ...
                        var r = g.position().left + g.outerWidth() - j.outerWidth();
                        c = -h.gutter, leftPosition = r + c
                    }
                    j.css({
                        position: "absolute",
                        top: g.position().top + n + o,
                        left: leftPosition
            ...
            a(document).on("keyup.radio", d, function(b) {
                if (9 === b.which) {
                    ...
                    return void c.one("blur", function(b) {
                        console.log(b), a(this).removeClass("tabbed")
                    })
                }
            });
...
// This is a patch from to fix modal left overlays: https://github.com/Dogfalo/materialize/pull/1691
! function(e) {
    var o = 0,
        t = 0,
        a = function() {
            return t++, "materialize-lean-overlay-" + t
        };
    e.fn.extend({
        openModal: function(t) {
            ...
            var i = {
                ...
                n = e(this),
                c = ++o;
            return "block" == n.css("display") ? (associatedOverlayID = n.data("overlay-id"), $associatedOverlay = e("#" + associatedOverlayID), $associatedOverlay.css("z-index", 1e3 + 2 * c), void n.css("z-index", 1e3 + 2 * c + 1)) : (overlayID = a(), $overlay = e('<div class="lean-overlay"></div>'), $overlay.attr("id", overlayID).css("z-index", 1e3 + 2 * c), n.data("overlay-id", overlayID).css("z-index", 1e3 + 2 * c + 1), e("body").append($overlay), t = e.extend(i, t), t.dismissible && ($overlay.click(function() {
                n.closeModal(t)
                ...
                queue: !1,
                ease: "easeOutCubic"
            }), n.data("associated-overlay", $overlay[0]), void(n.hasClass("bottom-sheet") ? n.velocity({
                bottom: "0",
                opacity: 1
            }, {
                duration: t.in_duration,
            ...
            }) : (e.Velocity.hook(n, "scaleX", .7), n.css({
                top: t.starting_top
            }), n.velocity({
                top: "10%",
                opacity: 1,
        ...
        closeModal: function(t) {
            var a = {
                ...
                n = i.data("overlay-id"),
                c = e("#" + n);
            t = e.extend(a, t), e("body").css("overflow", ""), i.find(".modal-close").off("click.close"), e(document).off("keyup.leanModal" + n), c.velocity({
                opacity: 0
            }, {
                ...
                complete: function() {
                    c.css({
                        display: "none"
                    }), "function" == typeof t.complete && t.complete(), c.remove(), o--
                }
            }) : i.velocity({
                top: t.starting_top,
                opacity: 0,
                ...
                duration: t.out_duration,
                complete: function() {
                    e(this).css("display", "none"), "function" == typeof t.complete && t.complete(), c.remove(), o--
                }
            })
        }
    }), e.fn.extend({
        leanModal: function(o) {
            return this.each(function() {
                var t = {
                        starting_top: "4%"
                    },
                ...
                e(this).click(function(o) {
                    a.starting_top = (e(this).offset().top - e(window).scrollTop()) / 1.15;
                    var t = e(this).attr("href") || "#" + e(this).data("target");
                    e(t).openModal(a), o.preventDefault()
                })
            })
        }
    })
